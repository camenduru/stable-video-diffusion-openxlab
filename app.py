...
os.system(f"git clone -b dev https://github.com/camenduru/generative-models /home/xlab-app-center/generative-models")
os.system(f"pip install -e generative-models")
os.system(f"pip install -q -e git+https://github.com/Stability-AI/datapipelines@main#egg=sdata")

os.system(f"mkdir /home/xlab-app-center/bin")
os.system(f"wget https://huggingface.co/camenduru/aria2/resolve/main/bin/aria2c -O /home/xlab-app-center/bin/aria2c")
os.environ['PATH'] = "/usr/local/share/python/.pyenv/versions/3.9.16/bin:/usr/local/share/python/.pyenv/libexec:/usr/local/share/python/.pyenv/plugins/python-build/bin:/usr/local/share/python/.pyenv/shims:/usr/local/share/python/.pyenv/bin:/usr/local/nvidia/bin:/usr/local/cuda/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/local/share/python/.local/bin:/home/xlab-app-center/bin"
os.system(f"chmod +x /home/xlab-app-center/bin/aria2c")
os.system(f"aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/vdo/stable-video-diffusion-img2vid-xt/resolve/main/svd_xt.safetensors?download=true -d /home/xlab-app-center/checkpoints -o svd_xt.safetensors")

os.system(f"mkdir -p /home/xlab-app-center/scripts/util/detection")
os.system(f"ln -s /home/xlab-app-center/generative-models/scripts/util/detection/p_head_v1.npz /home/xlab-app-center/scripts/util/detection/p_head_v1.npz")
os.system(f"ln -s /home/xlab-app-center/generative-models/scripts/util/detection/w_head_v1.npz /home/xlab-app-center/scripts/util/detection/w_head_v1.npz")
...
def sample(
    ...
    device: str = "cuda",
    output_folder: Optional[str] = "/home/xlab-app-center/outputs",
):
    """
